# Quick fix for local development - remove base href and use relative paths
$pages = Get-ChildItem "pages/*.html"

foreach ($page in $pages) {
    Write-Host "Fixing $($page.Name) for local development"
...
Write-Host "All pages fixed for local development!"
